...
module.exports = function (RED) {
    ...
    RED.nodes.registerType('human-pose-estimator', ModelAssetExchangeServerNode);
    ...
    RED.nodes.registerType('human-pose-estimator-service', ModelAssetExchangeServerServiceNode, {
        credentials: {
            temp: { type: 'text' }
        }
    });
