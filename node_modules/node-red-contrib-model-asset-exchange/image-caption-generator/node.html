...
<script type="text/javascript">
    RED.nodes.registerType('image-caption-generator-service', {
        category: 'config',
        defaults: {
            host: { value: "https://max-image-caption-generator.max.us-south.containers.appdomain.cloud", required: true },
...
<script type="text/x-red" data-help-name="image-caption-generator-service">
    ...
    <h3>cloud</h3>
        <p><b>Host</b>: https://max-image-caption-generator.max.us-south.containers.appdomain.cloud</p>
        <p><b>Name</b>: cloud</p>
    <h3>localhost</h3>
