...
module.exports = function (RED) {
    ...
    RED.nodes.registerType('facial-age-estimator', ModelAssetExchangeServerNode);
    ...
    RED.nodes.registerType('facial-age-estimator-service', ModelAssetExchangeServerServiceNode, {
        credentials: {
            temp: { type: 'text' }
        }
    });
